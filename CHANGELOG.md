...
- Battery status now uses macOS's reported power source and charging state, so
  the menu bar switches immediately between charging, plugged in and unplugged
  without stale battery-current readings.
